...
public class Design_level3 extends Levels{
public  Design_level3()
{
}
    int counter=3;
...
@Override
 ...
 img2 =new ImageView(im2);
 img2.setX(384);img2.setY(320);gg.getChildren().add(img2);
...
ImageView img5 =new ImageView(im5);
       int[][] design
            = {
                ...
                {9,1, 1, 1, 1, 1, 1, 1, 9, 9,9},
                {9,1, 9, 9, 4, 9, 9, 1, 9, 9,9},
                {9,1, 9, 2, 9, 1, 9, 1, 1, 9,9},
                {9,1, 4, 1, 2, 9, 2, 9, 1, 9,9},
                {9,1, 9, 9, 4, 1, 9, 9, 1, 9,9},
                {9,1, 9, 9, 9, 1, 9, 9, 1, 9,9},
       ...
       logic_2.logic(scene, gg, imh, boxs, dest,img2,counter,4);
 }
