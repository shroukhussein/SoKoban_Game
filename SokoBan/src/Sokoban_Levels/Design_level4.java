...
public class Design_level4 extends Levels{
    public Logic_2 logic_2;
public  Design_level4()
{}
    int counter=2; 
    ArrayList<ImageView>boxs=new ArrayList<ImageView>();
    ArrayList<ImageView>imh=new ArrayList<ImageView>();

    public Logic_2 getLogic_2() {
        return logic_2;
    }
...
@Override
 ...
 img2.setX(256);img2.setY(256);gg.getChildren().add(img2);
...
ImageView img5 =new ImageView(im5);
    int[][] design
            = {
                ...
                {9,1, 9, 9, 9, 9, 9, 9, 1, 9,9},
                {9,1, 9, 9, 9, 9, 9, 9, 1, 9,9},
                {9,1, 9, 9, 9, 2, 4, 9, 1, 9,9},
                {9,1, 9, 9, 4, 2, 9, 9, 1, 9,9},
                {9,1, 1, 1, 1, 1, 1, 1, 1, 9,9},
                {9,9, 9, 9, 9, 9, 9, 9, 9, 9,9}
             };      
       for(int i=0;i<8;i++)
       ...
       logic_2=new Logic_2();
       logic_2.logic(scene, gg, imh, boxs, dest,img2,counter,1);
 }
}