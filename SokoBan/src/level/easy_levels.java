...
public abstract class easy_levels {

   protected Color txt = new Color(51, 125, 155);
  protected  Image bg1;
  protected  Image box_gray;
  protected  Image box_yellow;
  ...
  protected  Image wall;
    ...
    public yellow_box y[];
    public easy_levels() {
        ImageIcon back1 = new ImageIcon("res/image/bg.jpg");
        bg1 = back1.getImage();
        ImageIcon boxg = new ImageIcon("res/image/box_gray.png");
        box_gray = boxg.getImage();
